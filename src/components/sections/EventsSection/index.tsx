                ...
                <div className="events-inner position-relative">
                  ...
                  <div className="d-flex justify-content-between px-4 py-2 bg-secondary">
                    <small className="text-white">
                      <i className="fas fa-calendar me-1 text-primary"></i> {event.horario}
                    </small>
                    <small className="text-white">
                      <i className="fas fa-map-marker-alt me-1 text-primary"></i> {event.local}
                    </small>
                  </div>
                </div>
                <div className="events-text p-4 border border-primary bg-white border-top-0 rounded-bottom">
                  <h4 className="h4">{event.titulo}</h4>
                  <p className="mb-0 mt-3">{event.descricao}</p>
                </div>
              </div>
            </Col>
          ))}
