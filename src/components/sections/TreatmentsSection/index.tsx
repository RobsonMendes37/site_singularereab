...
import { treatmentsData, homeData } from '../../../data';
      ...
      <Container className="py-1">
        <div className="text-center mx-auto wow fadeIn mb-5" data-wow-delay="0.1s" style={{ maxWidth: '800px' }}>
          <h1 style={{
            ...
            {homeData.sections.treatments.title}
          </h1>
        </div>
                ...
                <Link to={`/tratamento/${treatment.slug}`} style={{ textDecoration: 'none' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <i
                          className={treatment.icone}
                          style={{
                            fontSize: '16px', // Reduzido (era 24px)
                            color: treatment.cor
                          }}
                        />
                      </div>
                    ...
                    <h6 className="treatment-title" style={{
                      ...
                      fontSize: '14px',  // Reduzido para ficar mais proporcional
                      fontWeight: '700',
                      lineHeight: '1.4',
